 ...
 * ex: largestProduct(4) = 9*9*8*9 = 5832
 * * use "Sliding window"
 */
...
function largestProduct(numArray, n) {
  let start_index = 0;
  let end_index = n - 1;
  let maxProduct = -Infinity;

  while (end_index < numArray.length) {
    let tempProduct = 1;

    for (let i = start_index; i <= end_index; i++) tempProduct *= numArray[i];
...
console.log(largestProduct(thousandDigits, 4));
// 5832
